...
<html>
	<head>
		...
		<title>Tech Blog cua Long ne</title>
			...
			<div class="col-md-4">
				<div class="card">
					...
					<div class="card-body">
						...
						<a href="#" class="btn primary-background btn-outline-dark ">Read
							more</a>
					</div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="card">
					<div class="card-body">
						...
						<p class="card-text">Some quick example text to build on the
							card title and make up the bulk of the card's content.</p>
						<a href="#" class="btn primary-background btn-outline-dark">Read more</a>
					</div>
				</div>
			</div>
